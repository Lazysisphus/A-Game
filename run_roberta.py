...
def main():
    ...
    parser.add_argument("--model_type", default="chinese-roberta-wwm-ext", type=str)
    parser.add_argument("--model_name_or_path", default="../language_models/chinese-roberta-wwm-ext/", type=str)
    parser.add_argument("--do_lower_case", default=False, type=boolean_string)
    parser.add_argument("--output_dir", default="./state_models/chinese-roberta-wwm-ext/", type=str)
